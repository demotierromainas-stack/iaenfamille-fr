              ...
              <LiftCard>
                <article className="card flex h-full flex-col overflow-hidden">
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <Link
                      href={offer.href}
                      className={`group mt-6 inline-flex items-center gap-1.5 text-[13px] font-semibold ${linkTone[offer.tone]}`}
                    >
                      {offer.cta}
                      <ArrowRight
                  ...
                  {/* les cartes parents / stages portent un visuel en pied */}
                  {offer.ages === undefined && (
                    <PlaceholderImage
